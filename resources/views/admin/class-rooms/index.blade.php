...
@section('content')
    ...
    <div class="container mx-auto mb-4">
        ...
        <div class="mb-2">
            <x-breadcrumb :links="['Home' => route('admin.dashboard.index'), 'Class Rooms' => route('admin.class-rooms.index')]" />
        </div>
        ...
        <div class="mb-4">
            <h1 class="text-2xl text-white font-semibold">All Class Rooms</h1>
        </div>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg ">
            <div
                ...
                <!-- Search form -->
                <form method="GET" action="{{ route('admin.class-rooms.index') }}"
                    ...
                    @forelse ($rooms as $room)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                            ...
                            <td class="px-6 py-4 flex items-center gap-3">
                                <a href="{{ route('admin.class-rooms.edit', $room->id) }}"
