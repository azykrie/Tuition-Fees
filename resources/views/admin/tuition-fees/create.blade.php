...
@section('title', 'Create Tuition Fee')
    ...
    <div class="container mx-auto mb-6">
        <div class="mb-2">
            <x-breadcrumb :links="[
                ...
                'Create' => route('admin.tuition-fees.create'),
            ]" />
        </div>

        <div class="mb-4">
            <h1 class="text-2xl text-white font-semibold mb-4">Create Tuition Fee</h1>
        </div>

        <div class="bg-white dark:bg-gray-800 border border-gray-200 dark:border-gray-700 shadow-md rounded-lg p-6">
            <form action="{{ route('admin.tuition-fees.store') }}" method="POST" class="w-full">
                @csrf
                {{-- Name --}}
                <div class="mb-5">
