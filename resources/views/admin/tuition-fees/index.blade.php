...
@section('content')
    ...
    <div class="container mx-auto mb-4">
        ...
        <div class="mb-2">
            <x-breadcrumb :links="['Home' => route('admin.dashboard.index'), 'Tuition Fees' => route('admin.tuition-fees.index')]" />
        </div>
        ...
        <div class="mb-4">
            <h1 class="text-2xl text-white font-semibold">All Tuition Fees</h1>
        </div>
        ...
        <div class="relative overflow-x-auto shadow-md sm:rounded-lg ">
            <div
                ...
                <!-- Search form -->
                <form method="GET" action="{{ route('admin.tuition-fees.index') }}"
                    ...
                    @forelse ($tuitionFees as $fee)
                        <tr class="bg-white border-b dark:bg-gray-800 dark:border-gray-700 border-gray-200">
                           ...
                           justify-center items-center dark:hover:bg-gray-600 dark:hover:text-white"
                                                data-modal-hide="popup-modal-{{ $fee->id }}">
                                            ...
                                            <div class="p-4 md:p-5 text-center">
                                                ...
                                                <div class="flex items-center justify-center">
                                                    <form action="{{ route('admin.tuition-fees.destroy', $fee->id) }}"
                                                        method="POST">
                                                        @csrf
                                                        @method('DELETE')
                                                        <button type="submit"
                                       ...
                                       text-sm inline-flex items-center px-5 py-2.5 text-center">
                                                    ...
                                                    <button data-modal-hide="popup-modal-{{ $fee->id }}"
                                                        type="button"
