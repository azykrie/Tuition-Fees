            ...
            <form action="{{ route('admin.users.store') }}" method="POST" class="w-full">
                ...
                <div class="mb-5">
                    ...
                    <input type="text" name="name" value="{{ old('name') }}"
                        class="shadow-xs bg-gray-50 border @error('name') border-red-500 @else @enderror text-gray-900 text-sm rounded-md focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white"
